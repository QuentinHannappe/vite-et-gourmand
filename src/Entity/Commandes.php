...
class Commandes
{
    ...
    private ?\DateTime $date_presta = null;
    ...
    public function getDatePresta(): ?\DateTime
    {
        return $this->date_presta;
    }

    public function setDatePresta(\DateTime $date_presta): static
    {
